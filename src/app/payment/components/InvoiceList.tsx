//src/app/payment/components/InvoiceList.tsx - CORRECCIÓN DE FILTRADO
...
// ... (Bloque de Router, Tipos y Mocks - Mantenidos igual) ...
interface AppRouter {
    push: (path: string) => void;
    back: () => void;
}
let useRouter: () => AppRouter;
// ... (Lógica de importación de useRouter) ...
try {
...
const InvoiceList = () => {
    ...
    // Nuevo estado para la dirección de ordenamiento (Descendente por defecto)
